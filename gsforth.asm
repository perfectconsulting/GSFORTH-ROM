...
BZEROBRANCH_NFA ;(0branch)
		.DB $09^$80,'(0branch',$29^$80
		.DW ULESS_NFA
BZEROBRANCH_CFA
		>CHK_STK_MIN 1,BZEROBRANCH
		LDY STK+2,X
		BNE BZEROBRANCH_END
		LDY STK+1,X
BZEROBRANCH_END
...
NOBRANCH_NFA ;nobranch
		.DB $08^$80,'nobranc',$68^$80
		.DW BRANCH_NFA
NOBRANCH_CFA
		STX SCRATCH1
		PLA
...
CREATESCREENS_LOOP2
		...
		JSR OSBPUT_CFA
		JSR BLOOP_CFA
		.DW CREATESCREENS_LOOP2
		JSR BLOOP_CFA
		.DW CREATESCREENS_LOOP1
		JSR CLOSE_CFA
		JSR CR_CFA
		RTS
