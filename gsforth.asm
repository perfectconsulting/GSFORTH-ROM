...
TWODUP_CFA
		...
		STA STK+4,X
		RTS
		>HDLR_STK_UNDERFLOW TWODUP
		>HDLR_STK_OVERFLOW TWODUP
...
TWOOVER_CFA
		...
		STA STK+4,X
		RTS
		>HDLR_STK_UNDERFLOW TWOOVER
		>HDLR_STK_OVERFLOW TWOOVER
...
LOADUSING_NFA ;loadusing
		.DB $09^$80,'loadusin',$67^$80
		.DW USING_NFA
LOADUSING_CFA
		JSR CHANNEL_CFA
		JSR FETCH_CFA
