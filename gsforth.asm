...
FIRST   .EQ $1A00
    ...
    .DB $E2
    .DB ROM_HEADER_COPYRIGHT_STRING
ROM_HEADER_VERSION
    .DB $02
...
QRUNNING_NFA ;?running
    .DB $08^$80,'?runnin',$67^$80
    .DW  QLOADING_NFA
QRUNNING_CFA
    JSR BLK_CFA
    JSR FETCH_CFA
...
BUFFERQ_NFA ;buffer? ( blk --- t/f)
    .DB $07^$80,'buffer',$3F^$80
    .DW BUFFER_NFA
BUFFERQ_CFA
    >LITERAL $4000
    JSR OR_CFA
