...
ROM_ERROR_VCT
		...
		.DW $0000 ;IN
		.DW $000A ;BASE
		.DW FORTH_RELOCATION+2 ;CURRENT
		.DW FORTH_RELOCATION ;CONTEXT
		.DW $0000 ;LATEST
		.DW $0020 ;WIDTH
		.DW $0000 ;OUT
		.DW $0000 ;DPL
...
FORTH_RELOCATION	.EQ FORTH_BODY-ROM_USER_START+ORIGIN
...
EXPECT_CFA
		...
		LDA STK+3,X  ; addr lsb
		STA SCRATCH1
		LDA STK+4,X  ; addr msb
		STA SCRATCH2
		LDA STK+1,X ; count lsb
		STA SCRATCH3
		LDA #$20
		STA SCRATCH4 ; min ascii
		LDA #$8E
		STA SCRATCH5 ; max ascii
		INX
		INX
		INX
		INX
